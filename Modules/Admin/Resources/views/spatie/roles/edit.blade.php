                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        <a href="{{route('acl.roles.index')}}" class="btn btn-info mb-2 me-2"
                                           data-toggle="tooltip" title="Role List"> <i class="mdi mdi-text me-1"></i>{{translate('Role
                                            Lists')}}</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="example-text-input"
                                                       class="col-form-label text-right"><strong>{{translate('Role Name')}} <span
                                            ...
                                            <div class="col-md-9">
                                                <label for="example-text-input" class="col-form-label text-right">{{translate('Word
                                                    Restrictions')}}</label>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <label for="check_all" style="cursor: pointer">
                                                    <input type="checkbox" name="check_all" id="check_all"
                                                           style="transform: scale(1.5, 1.5)">&nbsp;&nbsp;&nbsp;<strong>{{translate('Check
                                                        all Permissions')}}</strong>
                                                </label>
                                                <hr class="mt-0 pt-0">
                                            </div>
                                                                        ...
                                                                        @foreach($chunk as $permission)
                                                                            <label>
                                                                                <input name="permission[]"
                                                                                       ...
                                                                                       class="name module-permissions-{{ $chunk_counter }} permissions" {{ in_array($permission->id, $rolePermissions) ? 'checked' : '' }}>&nbsp;
                                                                                {{ $permission->name }}
                                                                            </label>
                                                                            <br/>
                                                                        @endforeach
                                                                ...
                                                                @foreach($chunk as $permission)
                                                                    <label>
                                                                        <input name="permission[]" type="checkbox"
                                                                               value="{{ $permission->id }}"
                                                                               class="name permission-permmissions-{{ $chunk_counter }} permissions" {{ in_array($permission->id, $rolePermissions) ? 'checked' : '' }}>&nbsp;
                                                                        {{ $permission->name }}
                                                                    </label>
                                                                    <br/>
                                                                @endforeach
