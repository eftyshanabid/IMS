                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        @if(isOptionPermitted('group-create'))
                                            <a href="{{route('product-groups.create')}}" class="btn btn-info mb-2 me-2"
                                               data-toggle="tooltip" title="Add New Group"> <i class="mdi mdi-plus
                                           me-1"></i>{{translate('Add New Group')}}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
...
@section('javascript')
    ...
    <script>
        function showDetails(id) {
            $('#dataBody').empty().load('{{url(Request()->route()->getPrefix()."/product-groups")}}/' + id);
