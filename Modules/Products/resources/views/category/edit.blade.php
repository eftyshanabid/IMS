                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        <a href="{{ route('categories.index') }}" class="btn btn-info mb-2 me-2"
                                            data-toggle="tooltip" title="Category List"> <i
                                                class="mdi mdi-text
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <p class="mb-1 font-weight-bold"><label
                                                        for="code"><strong>{{ __('Code') }} <span
                                                                class="text-danger">&nbsp;*</span></strong></label>
                                                    {!! $errors->has('code')
                                                        ? '<span class="text-danger text-capitalize">' . $errors->first('code') . '</span>'
                                                        : '' !!}
                                                </p>
                                            ...
                                            <div class="col-md-4">
                                                <p class="mb-1 font-weight-bold"><label
                                                        for="name"><strong>{{ __('Name') }}<span
                                                                class="text-danger">&nbsp;*</span></strong></label>
                                                    {!! $errors->has('name')
                                                        ? '<span class="text-danger text-capitalize">' . $errors->first('name') . '</span>'
                                                        : '' !!}
                                                </p>
                                                <div class="input-group input-group-md mb-3 d-">
                                            ...
                                            @if ($departments->count() > 0)
                                                <div class="col-md-6">
                                                    <p class="mb-1 font-weight-bold"><label
                                                            for="parent"><strong>{{ __('Departments') }}</strong>:</label>
                                                        {!! $errors->has('hr_department_id')
                                                            ? '<span class="text-danger text-capitalize">' . $errors->first('department_id') . '</span>'
                                                            : '' !!}
                                                    </p>
                                                        ...
                                                        <select name="department_id[]" id="department_id"
                                                            ...
                                                            @foreach ($departments as $key => $department)
                                                                <option value="{{ $department->id }}"
                                                                    {{ in_array($department->id, $departmentsId) ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-12">
                                                <p class="mb-1 font-weight-bold"><label
                                                        for="description"><strong>{{ __('Description') }}</strong></label>
                                                    {!! $errors->has('name')
                                                        ? '<span class="text-danger text-capitalize">' . $errors->first('description') . '</span>'
                                                        : '' !!}
                                                </p>
                                                <div class="input-group input-group-md mb-3 d-">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <button type="submit" class="btn btn-success rounded pull-right m-1"><i
                                                        class="mdi mdi-plus"></i>&nbsp;{{ __('Update Category') }}</button>
                                            </div>
                                        </div>
