                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="select-search-group input-group input-group-md mb-3 d-">
                                                        <select name="department_id[]" id="department_id"
                                                            ...
                                                            @foreach($departments as $key => $department)
                                                                <option
                                                                    value="{{ $department->id }}" {{ in_array
                                                                    ($department->id, $departmentsId) ? 'selected' :
                                            ...
                                            <div class="col-md-12">
                                                <p class="mb-1 font-weight-bold"><label
                                                        for="description"><strong>{{ __('Description') }}</strong></label> {!! $errors->has('name')? '<span class="text-danger text-capitalize">'. $errors->first('description').'</span>':'' !!}
                                                </p>
                                                <div class="input-group input-group-md mb-3 d-">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <button type="submit" class="btn btn-success rounded pull-right m-1"><i
                                                        class="mdi mdi-plus"></i>&nbsp;{{ __('Update Category')
                                                        }}</button>
                                            </div>
                                        </div>
