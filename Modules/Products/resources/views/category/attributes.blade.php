                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-md mb-3 d-">
                                                    <select name="productAttributes[]" id="attributes"
                                                        ...
                                                        data-placeholder="Choose Attributes" onchange="updateAttributes()">
                                                        @if (isset($attributes[0]))
                                                            @foreach ($attributes as $key => $attribute)
                                                                <option value="{{ $attribute->id }}"
                                                                    {{ in_array($attribute->id, isset($categoryAttributes[0]) ? $categoryAttributes : []) ? 'selected' : '' }}>
                                                ...
                                                @if (isset($attributes[0]))
                                                    @foreach ($attributes as $key => $attribute)
                                                        @php
                                                            ...
                                                            $options =
                                                                isset($categoryAttribute->id) &&
                                                                !empty($categoryAttribute->options)
                                                                    ? json_decode($categoryAttribute->options, true)
                                                                    : [];
                                                        @endphp
                                                        <div class="col-md-6 mb-3 attributes attribute-{{ $attribute->id }}"
                                                            style="display: none">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="card">
                                                                                        ...
                                                                                        <select
                                                                                            ...
                                                                                            @if (isset($attribute->options[0]))
                                                                                                @foreach ($attribute->options as $key => $option)
                                                                                                    <option
                                                                                                        value="{{ $option->id }}"
                                                                                                        {{ isset($options[0]) && in_array($option->id, $options) ? 'selected' : '' }}>
                                                                                                        {{ $option->name }}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                            @endif
