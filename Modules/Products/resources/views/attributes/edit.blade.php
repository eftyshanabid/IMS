<form action="{{ route('attributes.update', $attribute->id) }}" method="post" accept-charset="utf-8"
    enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-3">
            <label for="code"><strong>{{ __('Attribute Code') }}:<span
        ...
        <div class="col-md-6">
            <label for="name"><strong>{{ __('Attribute Name') }}:<span
                        class="text-danger">&nbsp;*</span></strong></label>
            <div class="input-group input-group-md mb-3 d-">
        ...
        <div class="col-md-3">
            <label for="searchable"><strong>{{ __('Searchable ?') }}<span
                        class="text-danger">&nbsp;*</span></strong></label>
        ...
        <div class="col-md-12">
            ...
            <div class="input-group input-group-md mb-3 d-">
                <input type="text" name="description" id="description"
                    value="{{ old('description', $attribute->description) }}" class="form-control rounded">
            </div>
        </div>
    </div>
    <div class="row">
