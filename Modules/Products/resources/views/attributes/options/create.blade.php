                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        {!! Form::open(array('route' => 'attribute-options.store','method'=>'POST',
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-right">
                                                <a class="btn btn-dark btn-md" href="{{ url
                                                ('admin/attribute-options?attribute_id='.request()->get('attribute_id'))
                                                 }}"><i class="la la-times"></i>&nbsp;Cancel</a>
                                                <button type="submit" class="btn btn-success btn-md"><i
                                                        class="la la-save"></i>&nbsp;Save Attribute
                                                </button>
                                            </div>
                                        </div>
