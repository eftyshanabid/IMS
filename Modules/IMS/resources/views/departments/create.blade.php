                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        <a href="{{route('departments.index')}}" class="btn btn-info mb-2 me-2"
                                           data-toggle="tooltip" title="Departments List"> <i class="mdi mdi-text
                                           me-1"></i>{{translate('Departments Lists')}}</a>
                                    </div>
                                </div>
                            </div>
